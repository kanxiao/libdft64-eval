#define NGX_CONFIGURE " --with-cc=gcc --with-cc-opt='-O0 -mno-avx -fno-stack-protector' --with-pcre=/home/suncong/repo/libdft64-eval/nginx/lib/pcre-8.43 --with-pcre-opt='-g -O0 -mno-avx -fno-stack-protector' --with-zlib=/home/suncong/repo/libdft64-eval/nginx/lib/zlib-1.2.11 --with-zlib-opt='-g -O0 -mno-avx -fno-stack-protector'"
